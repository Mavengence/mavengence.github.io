 ...
 *
 * 1. Go to the projectsByRow object (around line 170)
...
const ProjectCard = styled.div`
  ...
  &:hover {
    ...
    .project-image { ${ProjectImageStyles} }
    .project-title { ${ProjectTitleStyles} }
    .project-banner { ${ProjectBannerStyles} }
    .project-tag { ${ProjectTagStyles} }
  }
...
const projectsByRow = {
  ...
  row2: [
    ...
    },
    {
      ...
      description: 'Classifying artistic styles in museum posters using LDA topic modeling, BERT embeddings, and neural network architectures for visual feature extraction and clustering.',
    ...
    },
    {
      ...
      description: "This project evaluates deep learning architectures for Parkinson's classification using raw sensor data. A ResNet autoencoder achieved 87% accuracy, as a decision support tool for doctors.",
...
const Projects = () => {
  const getGridPlacement = (project) => {
    ...
    if (window.innerWidth <= 768) {
      return { gridColumn: '1 / span 1', gridRow: 'auto', marginBottom: '2rem' };
    }
    ...
    if (projectsInRow === 1) {
      return { gridColumn: '3 / span 8', gridRow: `${row} / span 1` };
    }
                ...
                {({ ref, inView }) => (
                  ...
                  >
                    ...
                    <ProjectImage gradient={project.gradient} className="project-image">
                      {/* Safe: data is hardcoded, not user-supplied */}
                    ...
                    <ProjectContent>
                      <ProjectTags>
                        {project.technologies.map((tech) => (
                          <ProjectTag key={tech} className="project-tag">
                            {tech}
                          </ProjectTag>
                        ))}
                      </ProjectTags>
