...
`,g=(0,o.Ay)(n.P.h2)`
  ...
  font-weight: 900;
  color: ${r.lm.hivePrimary}; /* Main color */
  margin-bottom: 5rem;
  text-align: center;
...
`,b=o.Ay.div`
  ...
  background-image: 
    repeating-linear-gradient(
      45deg,
      ${e=>e.color||r.lm.hivePrimary}03 0px,
      ${e=>e.color||r.lm.hivePrimary}03 2px,
      transparent 2px,
      transparent 10px
    );
  z-index: 1;
  ...
  &:after {
    ...
    bottom: 0;
    background-image: 
      linear-gradient(45deg, ${e=>e.color||r.lm.hivePrimary}05 25%, transparent 25%),
      linear-gradient(-45deg, ${e=>e.color||r.lm.hivePrimary}05 25%, transparent 25%),
      linear-gradient(45deg, transparent 75%, ${e=>e.color||r.lm.hivePrimary}05 75%),
      linear-gradient(-45deg, transparent 75%, ${e=>e.color||r.lm.hivePrimary}05 75%);
...
//# sourceMappingURL=670.b8975c08.chunk.js.map