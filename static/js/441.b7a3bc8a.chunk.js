"use strict";(self.webpackChunktim_loehr_portfolio=self.webpackChunktim_loehr_portfolio||[]).push([[441],{2441:(s,e,t)=>{t.r(e),t.d(e,{default:()=>x});var i=t(5043),r=t(6867),o=t(7200),n=t(3549),a=t(579);const l=(0,r.Ay)(o.P.div)`
  background-color: ${n.lm.hiveDarkBg};
...
`,d=r.Ay.div`
  ...
  span {
    ...
    &:nth-child(1) {
      background: ${n.lm.hivePrimary};
    }
    
    &:nth-child(2) {
      background: ${n.lm.hiveSecondary};
    }
...
`,h=r.Ay.div`
  ...
  .highlight {
    color: ${n.lm.hiveSecondary};
    font-weight: bold;
  }
`,m=s=>{let{commands:e,title:t="terminal"}=s;const[r,o]=(0,i.useState)([]),[n,m]=(0,i.useState)(0),[g,u]=(0,i.useState)(0),[x,f]=(0,i.useState)(!0);return(0,i.useEffect)((()=>{if(0!==e.length&&n<e.length){const s=e[n];if(g<s.command.length){const s=setTimeout((()=>{u(g+1)}),50);return()=>clearTimeout(s)}{const e=setTimeout((()=>{o((e=>[...e,{...s,isTyping:!1,isComplete:!0}])),m(n+1),u(0)}),500);return()=>clearTimeout(e)}}}),[e,n,g]),(0,i.useEffect)((()=>{const s=setInterval((()=>{f((s=>!s))}),530);return()=>clearInterval(s)}),[]),(0,a.jsxs)(l,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6},className:"terminal",children:[(0,a.jsxs)(p,{children:[(0,a.jsxs)(d,{children:[(0,a.jsx)("span",{}),(0,a.jsx)("span",{}),(0,a.jsx)("span",{})]}),(0,a.jsx)(c,{children:t})]}),(0,a.jsxs)(h,{children:[r.map(((s,e)=>(0,a.jsxs)("div",{children:[(0,a.jsxs)("div",{children:[(0,a.jsx)("span",{className:"prompt",children:"\u03bb"})," ",(0,a.jsx)("span",{className:"path",children:"~/tim-loehr"})," ",(0,a.jsx)("span",{className:"command",children:s.command})]}),s.isComplete&&(0,a.jsx)("div",{className:"result",children:s.result})]},e))),n<e.length&&(0,a.jsxs)("div",{children:[(0,a.jsx)("span",{className:"prompt",children:"\u03bb"})," ",(0,a.jsx)("span",{className:"path",children:"~/tim-loehr"})," ",(0,a.jsx)("span",{className:"command",children:e[n].command.substring(0,g)}),x&&(0,a.jsx)("span",{className:"cursor"})]})]})]})};var g=t(5253);const u=r.Ay.div`
  max-width: 900px;
  margin: 0 auto;
  position: relative;
...
`,h=(0,i.Ay)(r.P.h2)`
  ...
  font-weight: 900;
  color: ${n.lm.hivePrimary}; /* Main color */
  margin-bottom: 5rem;
  text-align: center;
  text-transform: uppercase;
  letter-spacing: 2px;
...
`,g=i.Ay.div`
  ...
  background-image: 
    repeating-linear-gradient(
      45deg,
      ${s=>s.color||n.lm.hivePrimary}03 0px,
      ${s=>s.color||n.lm.hivePrimary}03 2px,
      transparent 2px,
      transparent 10px
    );
  z-index: 1;
  ...
  &:after {
    ...
    bottom: 0;
    background-image: 
      linear-gradient(45deg, ${s=>s.color||n.lm.hivePrimary}05 25%, transparent 25%),
      linear-gradient(-45deg, ${s=>s.color||n.lm.hivePrimary}05 25%, transparent 25%),
      linear-gradient(45deg, transparent 75%, ${s=>s.color||n.lm.hivePrimary}05 75%),
      linear-gradient(-45deg, transparent 75%, ${s=>s.color||n.lm.hivePrimary}05 75%);
...
`,s=>{let{title:e,children:t,background:i,titleColor:r,underlineColor:n,underlineSecondary:l,glowColor:c,gridColor:u,gridOpacity:x,id:f,className:b,..._}=s;return(0,a.jsxs)(p,{id:f,background:i,className:b||"",..._,children:[(0,a.jsx)(g,{color:u,opacity:x}),(0,a.jsx)(d,{children:(0,a.jsx)(o.pL,{threshold:.2,triggerOnce:!0,children:s=>{let{ref:i,inView:o}=s;return(0,a.jsxs)(a.Fragment,{children:[e&&(0,a.jsxs)(h,{ref:i,color:r,"data-text":e,initial:{opacity:0,y:-20},animate:o?{opacity:1,y:0}:{},transition:{duration:.8,type:"spring",stiffness:100},className:"section-title",children:[(0,a.jsx)("span",{"data-text":e,children:e}),e]}),(0,a.jsx)(m,{initial:{opacity:0,y:30},animate:o?{opacity:1,y:0}:{},transition:{duration:.8,delay:.2,type:"spring",stiffness:80},children:t})]})}})})]})})},5843:(s,e,t)=>{t.d(e,{pL:()=>h});var i=t(5043),r=Object.defineProperty,o=(s,e,t)=>((s,e,t)=>e in s?r(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t)(s,"symbol"!==typeof e?e+"":e,t),n=new Map,a=new WeakMap,l=0,p=void 0;function d(s){return Object.keys(s).sort().filter((e=>void 0!==s[e])).map((e=>{return`${e}_${"root"===e?(t=s.root,t?(a.has(t)||(l+=1,a.set(t,l.toString())),a.get(t)):"0"):s[e]}`;var t})).toString()}function c(s,e){let t=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},i=arguments.length>3&&void 0!==arguments[3]?arguments[3]:p;if("undefined"===typeof window.IntersectionObserver&&void 0!==i){const r=s.getBoundingClientRect();return e(i,{isIntersecting:i,target:s,intersectionRatio:"number"===typeof t.threshold?t.threshold:0,time:0,boundingClientRect:r,intersectionRect:r,rootBounds:r}),()=>{}}const{id:r,observer:o,elements:a}=function(s){const e=d(s);let t=n.get(e);if(!t){const i=new Map;let r;const o=new IntersectionObserver((e=>{e.forEach((e=>{var t;const o=e.isIntersecting&&r.some((s=>e.intersectionRatio>=s));s.trackVisibility&&"undefined"===typeof e.isVisible&&(e.isVisible=o),null==(t=i.get(e.target))||t.forEach((s=>{s(o,e)}))}))}),s);r=o.thresholds||(Array.isArray(s.threshold)?s.threshold:[s.threshold||0]),t={id:e,observer:o,elements:i},n.set(e,t)}return t}(t),l=a.get(s)||[];return a.has(s)||a.set(s,l),l.push(e),o.observe(s),function(){l.splice(l.indexOf(e),1),0===l.length&&(a.delete(s),o.unobserve(s)),0===a.size&&(o.disconnect(),n.delete(r))}}var h=class extends i.Component{constructor(s){super(s),o(this,"node",null),o(this,"_unobserveCb",null),o(this,"handleNode",(s=>{this.node&&(this.unobserve(),s||this.props.triggerOnce||this.props.skip||this.setState({inView:!!this.props.initialInView,entry:void 0})),this.node=s||null,this.observeNode()})),o(this,"handleChange",((s,e)=>{s&&this.props.triggerOnce&&this.unobserve(),function(s){return"function"!==typeof s.children}(this.props)||this.setState({inView:s,entry:e}),this.props.onChange&&this.props.onChange(s,e)})),this.state={inView:!!s.initialInView,entry:void 0}}componentDidMount(){this.unobserve(),this.observeNode()}componentDidUpdate(s){s.rootMargin===this.props.rootMargin&&s.root===this.props.root&&s.threshold===this.props.threshold&&s.skip===this.props.skip&&s.trackVisibility===this.props.trackVisibility&&s.delay===this.props.delay||(this.unobserve(),this.observeNode())}componentWillUnmount(){this.unobserve()}observeNode(){if(!this.node||this.props.skip)return;const{threshold:s,root:e,rootMargin:t,trackVisibility:i,delay:r,fallbackInView:o}=this.props;this._unobserveCb=c(this.node,this.handleChange,{threshold:s,root:e,rootMargin:t,trackVisibility:i,delay:r},o)}unobserve(){this._unobserveCb&&(this._unobserveCb(),this._unobserveCb=null)}render(){const{children:s}=this.props;if("function"===typeof s){const{inView:e,entry:t}=this.state;return s({inView:e,entry:t,ref:this.handleNode})}const{as:e,triggerOnce:t,threshold:r,root:o,rootMargin:n,onChange:a,skip:l,trackVisibility:p,delay:d,initialInView:c,fallbackInView:h,...m}=this.props;return i.createElement(e||"div",{ref:this.handleNode,...m},s)}}}}]);
//# sourceMappingURL=441.b7a3bc8a.chunk.js.map